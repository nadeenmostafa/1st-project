...
<body>
   ...
   <form action="save.php" method="POST" enctype="multipart/form-data">
    ...
    <!-- <tr> 
      ...
      <td><input type="text" name="ext" value="" ></td></tr>
      <tr><td><label for="">Profile Photo</label></td>
      <td><input type="file" name="image" id=""></td></tr>
      <tr>
